...
func TestNew_AppliesDefaults(t *testing.T) {
	...
	if r.cfg.Timeout != 200*time.Millisecond {
...
func TestSpliceMarkers_Idempotent(t *testing.T) {
	...
	first := spliceMarkers("ssn 222-33-4444 today",
		[]Span{{Start: 4, End: 15, EntityType: "US_SSN", Score: 1}}, 0.5)
	second := spliceMarkers(first.Text, nil, 0.5)
